...
const EducationCard = ({ item, index, isEven }) => {
  return (
    <motion.div
      ...
      className={`relative flex flex-col md:flex-row items-center mb-20 last:mb-0 ${isEven ? 'md:flex-row-reverse' : ''
        }`}
    >
      ...
      {/* Content Card */}
      <div className={`pl-12 md:pl-0 w-full md:w-1/2 ${isEven ? 'md:pl-20 text-left md:text-right' : 'md:pr-20 text-left'
        }`}>
        <motion.div
        ...
        >
          ...
          <div className={`flex flex-wrap gap-4 text-sm text-earth-text/60 mb-6 font-medium ${isEven ? 'md:justify-end' : 'justify-start'
            }`}>
